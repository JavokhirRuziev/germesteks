(function (t, e) {
    ...
    (function t() {
            ...
            function et(t) {
                ...
                if (t[0] === 'þ' && t[1] === 'ÿ') {
                    for (e = 2; e < r; e += 2) {
                        n.push(
                            String.fromCharCode(
                                (t.charCodeAt(e) << 8) | t.charCodeAt(e + 1)
                            )
                        );
                    }
                } else {
            ...
            (function t() {
                ...
                var s = {
                            ...
                            try {
                                if (s === n) {
                                    ...
                                    if (i.thisPromise._unhandledRejection) {
                                        this.removeUnhandeledRejection(
                                            i.thisPromise
                                        );
                                    }
                                }
                    ...
                    removeUnhandeledRejection: function t(e) {
                        ...
                        for (
                            var r = 0;
                            r < this.unhandledRejections.length;
                            r++
                        ) {
                        ...
                        setTimeout(
                            function t() {
                                ...
                                for (
                                    ...
                                    if (
                                        e - this.unhandledRejections[r].time >
                                        i
                                    ) {
                                        var n =
                                            this.unhandledRejections[r].promise
                                                ._value;
                    ...
                    getPathGenerator: function t(e, r) {
                        if (!(r in this.compiledGlyphs)) {
                            ...
                            if (this.options.isEvalSupported && h.value) {
                                ...
                                this.compiledGlyphs[r] = new Function(
                                    'c',
                                    'size',
                                    l
                                );
                    ...
                    for (var a = 0; a < r.length; a += 2) {
                        ...
                        n +=
                            ...
                            i !== 38
                                ...
                                : '&#x' +
                                  (65536 + i).toString(16).substring(1) +
                                  ';';
                    }
                    return '>' + n;
                });
                ...
                parse: function t() {
                    ...
                    for (l = 0, h = a.length; l < h; l++) {
                        ...
                        for (c = 0, u = i.childNodes.length; c < u; c++) {
                            if (
                                i.childNodes[c].nodeName.toLowerCase() !==
                                '#text'
                            ) {
                                s = i.childNodes[c];
            ...
            var y = (function t() {
                ...
                i.inherit(e, g, {
                    render: function t() {
                        ...
                        for (
                            var r = 0, n = this.data.options.length;
                            r < n;
                            r++
                        ) {
                            ...
                            if (
                                this.data.fieldValue.indexOf(a.displayValue) >=
                                0
                            ) {
                ...
                r.prototype = {
                    render: function t() {
                        ...
                        if (a) {
                            ...
                            var o = e * (255 - a[1]) + a[1];
                            var l = e * (255 - a[2]) + a[2];
                            n.style.backgroundColor = i.makeCssRgb(
                                s | 0,
                                o | 0,
                                l | 0
                            );
                        ...
                        for (var n = 0, a = e.annotations.length; n < a; n++) {
                            ...
                            var s = {
                                ...
                                imageResourcesPath:
                                    ...
                                    u('imageResourcesPath'),
                                renderInteractiveForms:
                                    e.renderInteractiveForms || false,
                            };
                            var o = r.create(s);
                            if (o.isRenderable) {
        ...
        (function (t, e) {
            ...
            var i = (function t() {
                ...
                function p() {
                    ...
                    p.gl = e;
                    p.canvas = t;
                    p.resolutionLocation = e.getUniformLocation(
                        o,
                        'u_resolution'
                    );
                ...
                function b() {
                    ...
                    u.gl = e;
                    u.canvas = t;
                    u.resolutionLocation = e.getUniformLocation(
                        o,
                        'u_resolution'
                    );
                ...
                fromIR: function t(e) {
                    ...
                    return {
                        ...
                        getPattern: function t(e, h, u) {
                            var f;
                            if (u) {
                                f = n.singularValueDecompose2dScale(
        ...
        (function (t, e) {
            ...
            function j(t) {
                if (!t.mozCurrentTransform) {
                    ...
                    t._transformMatrix = t._transformMatrix || [
                        1, 0, 0, 1, 0, 0,
                    ];
                    t._transformStack = [];
            ...
            var N = (function t() {
                ...
                n.prototype = {
                    beginDrawing: function t(e, r, n) {
                        ...
                        this.ctx.restore();
                        if (n) {
                            var s = this.cachedCanvases.getCanvas(
                                'transparent',
                                a,
                                i,
                                true
                    ...
                    beginGroup: function t(e) {
                        ...
                        var a = u.getAxialAlignedBoundingBox(
                            e.bbox,
                    ...
                    paintImageMaskXObjectGroup: function t(e) {
                        ...
                        for (var i = 0, s = e.length; i < s; i++) {
                            ...
                            var l = o.width,
                                c = o.height;
                            var h = this.cachedCanvases.getCanvas(
                                'maskCanvas',
                                l,
                                c
                            );
            ...
            var K = (function t() {
                ...
                e.prototype = {
                    ...
                    render: function t(e) {
                        ...
                        var a =
                            e.renderInteractiveForms === true ? true : false;
                    ...
                    getOperatorList: function t() {
                        ...
                        if (!n.opListReadCapability) {
                            ...
                            this.transport.messageHandler.send(
                                'RenderPageRequest',
                                { pageIndex: this.pageIndex, intent: r }
                            );
                        }
                    ...
                    getTextContent: function t(e) {
                        return this.transport.messageHandler.sendWithPromise(
                            'GetTextContent',
                            {
                                pageIndex: this.pageNumber - 1,
                                normalizeWhitespace:
                                    e && e.normalizeWhitespace === true
                                        ? true
                                        : false,
                                combineTextItems:
                                    e && e.disableCombineTextItems === true
                                        ? false
                                        : true,
                            }
                        );
                    ...
                    _destroy: function t() {
                        ...
                        Object.keys(this.intentStates).forEach(function (t) {
                            ...
                            r.renderTasks.forEach(function (t) {
                                var r = t.capability.promise.catch(
                                    function () {}
                                );
                                e.push(r);
                                t.cancel();
                    ...
                    _tryCleanup: function t() {
                        if (
                            ...
                            Object.keys(this.intentStates).some(function (t) {
                                ...
                                return (
                                    e.renderTasks.length !== 0 ||
                                    e.receivingOperatorList
                                );
                            }, this)
                        ) {
                            return;
                    ...
                    startCleanup: function t() {
                        this.messageHandler
                            ...
                            .then(
                                function t() {
                                    for (
                                        var e = 0, r = this.pageCache.length;
                                        e < r;
                                        e++
                                    ) {
                ...
                e.prototype = {
                    initializeGraphics: function t(e) {
                        ...
                        if (
                            N('pdfBug') &&
                            R.StepperManager &&
                            R.StepperManager.enabled
                        ) {
                            this.stepper = R.StepperManager.create(
                                this.pageNumber - 1
                            );
        ...
        (function (t, e) {
            ...
            g.disableWorker =
                g.disableWorker === undefined ? false : g.disableWorker;
            g.workerSrc = g.workerSrc === undefined ? null : g.workerSrc;
            g.disableRange =
                g.disableRange === undefined ? false : g.disableRange;
            g.disableStream =
                g.disableStream === undefined ? false : g.disableStream;
            g.disableAutoFetch =
                g.disableAutoFetch === undefined ? false : g.disableAutoFetch;
            g.pdfBug = g.pdfBug === undefined ? false : g.pdfBug;
            g.postMessageTransfers =
                g.postMessageTransfers === undefined
                    ? true
                    : g.postMessageTransfers;
            g.disableCreateObjectURL =
                g.disableCreateObjectURL === undefined
                    ...
                    : g.disableCreateObjectURL;
            g.disableWebGL =
                g.disableWebGL === undefined ? true : g.disableWebGL;
            g.externalLinkTarget =
                g.externalLinkTarget === undefined
                    ? d.NONE
                    : g.externalLinkTarget;
            g.externalLinkRel =
    ...
    t.UnexpectedResponseException =
        a.pdfjsSharedUtil.UnexpectedResponseException;
